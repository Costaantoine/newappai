...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    ...
    <div className="glass p-6 rounded-[2rem] border-white/5 hover:scale-[1.02] transition-all duration-300 flex flex-col">
      ...
      <h3 className="text-xl font-bold mb-2 text-white group-hover:text-sky-400 transition-colors">{title}</h3>
      ...
      <div className="flex items-center justify-between mt-auto">
        ...
        <div className="flex gap-2">
          <Link
            ...
            className="px-4 py-2 rounded-full text-sm font-bold border border-sky-500/30 text-sky-400 hover:bg-sky-500/10 transition"
          >
            Voir plus
          </Link>
          <button

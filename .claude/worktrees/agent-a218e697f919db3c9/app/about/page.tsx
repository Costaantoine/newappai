    ...
    <>
      ...
      <main className="min-h-screen bg-slate-950 overflow-x-hidden">
        <section className="relative pt-40 pb-20 px-6 flex flex-col items-center">
          ...
          <h1 data-section="about-title" className="text-4xl md:text-7xl font-bold mb-8 tracking-tight text-center text-white leading-tight animate-fade-in-up">
          ...
          <p data-section="about-subtitle" className="text-slate-400 max-w-3xl text-lg md:text-2xl mb-14 leading-relaxed text-center font-medium animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
            {getText('about_subtitle', 'Une passion pour l\'innovation, une mission pour votre réussite.')}
          </p>

          <div className="w-full max-w-5xl mx-auto backdrop-blur-md bg-white/5 p-8 md:p-14 rounded-[3rem] border border-white/10 relative overflow-hidden animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20">
              ...
              <div className="space-y-8">
                <h2 data-section="about-values" className="text-3xl font-bold mb-8 text-white">{getText('about_values_title', 'Nos Valeurs')}</h2>

          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <div className="glass p-4 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <button onClick={(e) => { e.preventDefault(); openEdit({ site: settings?.site || {} }, 'Couleurs', [
            ...
            <div className="glass p-4 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <button onClick={(e) => { e.preventDefault(); openEdit({ header: settings?.header || {} }, 'Header', [
            ...
            <div className="glass p-4 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <button onClick={(e) => { e.preventDefault(); openEdit({ footer: settings?.footer || {} }, 'Footer', [
            ...
            <div className="glass p-4 rounded-xl">
              <div className="flex items-center justify-between">
                ...
                <button onClick={(e) => { e.preventDefault(); openEdit({ animations: settings?.animations || {} }, 'Animations', [
          ...
          <div className="glass p-6 rounded-2xl space-y-4">
            <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
              <div>
                ...
                <p className="text-white">{settings?.contact_page?.title || 'Contactez l\'avenir'}</p>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
              <div>
                ...
                <p className="text-white">{settings?.contact?.address || 'Non définie'}</p>
              </div>
          ...
          <div className="glass p-6 rounded-2xl space-y-4">
            {contactTexts.map(item => (
              <div key={item.key} className="flex items-center justify-between p-3 bg-white/5 rounded-lg">
                ...
                <button onClick={(e) => { e.preventDefault(); openEdit(texts.find(t => t.key === item.key) || { key: item.key }, `Modifier ${item.label}`, [{ name: '.', label: 'Texte', type: 'languages' }], 'text') }} className="px-3 py-1 bg-sky-500 text-white rounded text-sm hover:bg-sky-400">Modifier</button>
              </div>
            ))}
          </div>
        </section>

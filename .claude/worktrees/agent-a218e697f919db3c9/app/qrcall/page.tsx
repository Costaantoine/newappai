      ...
      <main className="min-h-screen bg-slate-950 overflow-x-hidden">
        ...
        <section className="relative pt-40 pb-20 px-6 flex flex-col items-center text-center">
          ...
          <div className="max-w-4xl mx-auto">
            <div data-section="qrcall-badge" className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-sm text-sky-400 mb-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a data-section="qrcall-cta-1" href="https://qrcall.newappai.com" className="bg-sky-500 text-white px-8 py-4 rounded-full font-bold hover:bg-sky-400 transition shadow-lg shadow-sky-500/20">
                Créer mon QR code
              </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="backdrop-blur-md bg-white/5 p-8 rounded-[2rem] border border-white/10 text-center">
                <div className="w-16 h-16 bg-sky-500/20 rounded-2xl flex items-center justify-center text-sky-400 text-2xl font-bold mx-auto mb-6">
                  {item.step}
                </div>
            ...
            {PLANS.map((plan) => (
              <div
                ...
                className={`backdrop-blur-md p-8 rounded-[2rem] border flex flex-col ${
                  plan.popular
                    ? 'bg-sky-500/5 border-sky-500/40 shadow-[0_0_30px_rgba(56,189,248,0.15)] scale-[1.02]'
                    : 'bg-white/5 border-white/10'
                }`}
              >
                {plan.popular && (
                  <span data-section="qrcall-popular" className="text-xs font-bold uppercase tracking-widest text-sky-400 bg-sky-500/10 px-3 py-1 rounded-full w-fit mb-4">
                    Populaire
                  </span>
                )}
        ...
        <section id="building" className="max-w-4xl mx-auto px-6 py-20">
          <div className="backdrop-blur-md bg-white/5 p-10 md:p-16 rounded-[2.5rem] border border-indigo-500/30 shadow-[0_0_30px_rgba(129,140,248,0.1)]">
            <div className="text-center mb-10">
              <div data-section="qrcall-building-badge" className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/20 text-indigo-400 text-xs font-bold uppercase tracking-widest mb-4">
                Nouveau
              </div>
              ...
              <div className="backdrop-blur-md bg-white/5 p-6 rounded-2xl border border-white/10">
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="border-t border-white/10 pt-3 flex justify-between font-bold">
                    ...
                    <span className="text-indigo-400">49.90 €/mois</span>
                  </div>
                </div>
                <a
                  href="https://qrcall.newappai.com"
                  className="mt-6 w-full block text-center bg-indigo-500 text-white py-3 rounded-full font-bold hover:bg-indigo-400 transition shadow-lg shadow-indigo-500/20"
                >

...
/** Pictogrammes SVG par clé de zone (priorité 2 : après icon_url, avant badge). */
export const zoneIcons: Record<string, ReactNode> = {
...
/** Images d'illustration webp par clé de zone (affichées en haut des cartes). */

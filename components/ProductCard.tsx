...
function getProductUrl(title: string | any): string | null {
      ...
      {imageUrl ? (
        ...
        <div className="relative w-full h-48 mb-4 rounded-xl overflow-hidden bg-slate-800 flex items-center justify-center border border-white/5">
          <div className="text-slate-600 flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] uppercase font-bold tracking-widest opacity-50">{t?.product?.no_image || 'Aucune image'}</span>
          </div>
        </div>
      )}

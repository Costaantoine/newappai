      ...
      <div className="bg-slate-900 rounded-2xl p-6 w-full max-w-2xl border border-white/10 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex gap-2 mb-4">
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'upload' ? 'bg-violet-500 text-white' : 'bg-slate-800 text-slate-400'}`}
          >
            Upload
          </button>
          <button
            onClick={() => setActiveTab('url')}
            className={`px-4 py-2 rounded-lg font-medium ${activeTab === 'url' ? 'bg-violet-500 text-white' : 'bg-slate-800 text-slate-400'}`}
          >
            URL
          </button>
        </div>
          ...
          <div className="space-y-4">
            {!preview ? (
              <div 
                ...
                className="border-2 border-dashed border-slate-600 rounded-xl p-8 text-center cursor-pointer hover:border-violet-500 transition"
              >

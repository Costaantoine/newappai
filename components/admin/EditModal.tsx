        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {fields.map((field) => (
            <div key={field.name}>
              ...
              {field.description && (
                <p className="text-xs text-slate-500 italic mb-2">{field.description}</p>
              )}
              ...
              {field.type === 'languages' ? (
                <div className="space-y-4">
                  <div className="flex justify-between items-center bg-slate-800/50 p-2 rounded-lg border border-white/5">
                    ...
                    <button
                      ...
                      className="text-[10px] bg-violet-500/20 text-violet-400 px-2 py-1 rounded border border-violet-500/30 hover:bg-violet-500/40 transition-colors"
                    >
                      ...
                      return (
                        <div key={lang.key} className="space-y-1">
                          ...
                          <textarea
                            ...
                            className="w-full bg-slate-800 border border-white/10 rounded-lg px-3 py-2 text-white h-20 text-sm focus:border-violet-500/50 outline-none transition-colors"
                ...
                <ColorPicker
                  value={getNestedValue(data, field.name) || '#8b5cf6'}

...
export default function AudioButton() {
  ...
  return (
    <button
      onClick={toggleAudio}
      className="fixed bottom-6 right-24 w-14 h-14 rounded-full text-white flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 z-50"
      style={{
        backgroundColor: settings?.buttons?.primary_color || '#8b5cf6'
      }}
    >
      {isPlaying ? (

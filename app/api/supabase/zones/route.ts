...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const { key, title_key, subtitle_key, badge, color, url, site_url, cta_key, newtab_key, icon_url, order, active } = body
...
export async function PUT(request: NextRequest) {
  ...
  try {
    const body = await request.json()
    const { id, key, title_key, subtitle_key, badge, color, url, site_url, cta_key, newtab_key, icon_url, order, active } = body
    ...
    if (site_url !== undefined) data.site_url = site_url

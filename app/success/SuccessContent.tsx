    ...
    <>
      ...
      <section className="relative pt-48 pb-20 px-6 flex flex-col items-center">
        ...
        <p className="text-slate-300 max-w-xl text-lg mb-8 text-center leading-relaxed">
          ...
          {customerEmail && (
            <span className="block mt-2">
              {t.success.emailSent} <span className="text-violet-400">{customerEmail}</span>.
            </span>
          )}
        </p>
        ...
        <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
          <a href="/" className="bg-violet-500 text-white px-8 py-3 rounded-full font-bold hover:bg-violet-400 transition">
            {t.success.home}
          </a>

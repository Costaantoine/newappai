    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-md glass p-10 rounded-[2.5rem] border-white/5">
        ...
        <div className="space-y-6">
          <div className="flex flex-col space-y-2">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-slate-950/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-violet-500 focus:ring-1 focus:ring-violet-500 transition pr-12"
          ...
          <button
            onClick={handleLogin}
            className="w-full bg-violet-500 text-white py-3 rounded-full font-bold hover:bg-violet-400 transition"
          >
            Se connecter
          </button>
        </div>
        ...
        <div className="mt-6 text-center">
          <Link href="/" className="text-slate-400 text-sm hover:text-violet-400 transition">
            ← Retour au site
          </Link>
        </div>
      </div>

    ...
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 bg-slate-950/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-violet-500 text-sm"
          placeholder="https://example.com/sound.mp3"
        />
        <button
          onClick={testSound}
          className="px-4 py-3 rounded-full bg-violet-500/20 hover:bg-violet-500/40 text-violet-400 font-bold transition flex items-center gap-2"
        >
          {isPlaying ? (

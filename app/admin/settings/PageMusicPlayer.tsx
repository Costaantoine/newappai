      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full bg-slate-950/50 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-violet-500 text-sm"
        ...
        <div className="flex gap-2">
          <button
            ...
            className="flex-1 py-3 rounded-full bg-violet-500 hover:bg-violet-400 text-white font-bold transition flex items-center justify-center gap-2"
          >
            {isPlaying ? (
              <>

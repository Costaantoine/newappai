          ...
          <AppleCard padding="lg" className="max-w-3xl mx-auto">
            ...
            {globalSettings?.contact && (globalSettings.contact.email || globalSettings.contact.phone || globalSettings.contact.address) && (
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 p-6 backdrop-blur-2xl bg-white/[0.03] rounded-2xl border border-white/[0.08] shadow-lg shadow-black/30">
                ...
                {globalSettings.contact.phone && (
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <a href={`tel:${globalSettings.contact.phone}`} className="text-white font-semibold hover:text-violet-400 transition text-sm">{globalSettings.contact.phone}</a>
                    </div>
                  </div>
                )}

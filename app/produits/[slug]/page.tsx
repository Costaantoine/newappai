...
const slugMap: Record<string, ProductInfo> = {
  ...
  'click-and-collect': {
    titleFr: 'Click and Collect',
    subtitle: 'Commande en ligne, retrait en magasin — zéro intermédiaire',
    longDesc: "Vos clients commandent depuis leur téléphone, choisissent un créneau de retrait et récupèrent leur commande prépratée en magasin. Pas de livreur, pas de commission à une plateforme tierce, pas de contrainte horaire. Votre commerce, votre rythme.\n\nLe Click and Collect élimine les files d'attente et les appels téléphoniques pour les commandes. Vos clients naviguent votre catalogue en ligne, composent leur panier, règlent par carte bancaire et choisissent le moment de passage. Vous recevez la commande en temps réel, la préparez et le client la récupère au comptoir.\n\nContrairement aux grandes plateformes qui prennent 15 à 30% de commission sur chaque vente, notre solution vous appartient. Pas de commission, pas de frais cachés. Vous gardez 100% de votre chiffre d'affaires et le contrôle total de votre relation client.",
    features: [
      'Catalogue produits personnalisable avec photos, descriptions et prix',
      'Panier et paiement en ligne sécurisé (Stripe)',
      'Gestion des créneaux de retrait (horaires, capacité, delai minimum)',
      'Notifications en temps réel (nouvelle commande, pret a retirer)',
      'Interface commerçant pour valider, preparer et marquer les commandes comme pretes',
      'Statistiques de ventes et historique des commandes',
      'Responsive mobile : vos clients commandent facilement depuis leur telephone',
    ],
    options: [
      'Integration avec votre systeme de caisse existant',
      'Application mobile brandee (iOS et Android)',
      'Module de fidelite et programme de recompenses',
    ],
    priceNote: 'Forfait unique de 999€ TTC. Pas de commission sur les ventes, pas d\'abonnement mensuel. Maintenance et support inclus la premiere annee.',
    forWho: 'Commercants de proximite, boulangeries, patisseries, boucheries, epiceries, restaurants qui veulent proposer la commande en ligne sans payer de commission a des plateformes comme Uber Eats ou Deliveroo.',
  },
